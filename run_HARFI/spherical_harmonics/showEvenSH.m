function []= showEvenSH(SH,lmax,spherenum,complex_or_real)
% SH must be column vector of real_or_complex, even order SH coefficients
...
[sh_sphere,~,~] = construct_SH_basis(lmax, [sphere_x(:) sphere_y(:) sphere_z(:)], 2, complex_or_real);
