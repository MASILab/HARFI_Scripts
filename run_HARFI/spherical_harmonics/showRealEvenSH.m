function []= showRealEvenSH(SH,lmax,spherenum)
% SH must be column vector of real, even order SH coefficients
...
[sh_sphere,~,~] = construct_SH_basis(lmax, [sphere_x(:) sphere_y(:) sphere_z(:)], 2, 'real');
